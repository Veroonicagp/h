 ...
 * Use the [ActivitiesAdvenListFragment.newInstance] factory method to
...
class ActivitiesAdvenListFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ActivitiesAdvenListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ActivitiesAdvenListFragment().apply {
